...
È un **unico file HTML** senza dipendenze esterne. I dati restano nel browser (archivio locale) e si possono salvare e ripristinare come copia di sicurezza in formato JSON. Alla prima apertura si trovano dati dimostrativi con persone e contatti di fantasia.
